...
class _ExampleARowState extends State<ExampleARow> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: customAppbar(title: 'ARow', context: context),
        body: Column(
          children: <Widget>[
            Container(
                ...
                child: ARow(
                  leftChild: Container(
                    width: 30,
                    child: icontupian5(color: Color.fromRGBO(228, 228, 228, 1)),
                  ),
                  centerChild: Text(
                    '个人信息',
              ...
              child: ARow(
                ...
                leftChild: Container(
                  ...
                  child: Container(
                    ...
                    child: icontupian11(
                        color: Color.fromRGBO(228, 228, 228, 1), size: 20),
                  ),
                ),
                centerChild: Text(
                  '咖啡钱包',
                  ...
                  ARow(
                    ...
                    rightChild: Container(
                      ...
                      decoration: BoxDecoration(
                          border:
                              Border.all(color: Color.fromRGBO(99, 71, 58, 1)),
