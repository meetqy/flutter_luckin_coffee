              ...
              Container(
                ...
                child: Row(children: <Widget>[
                  ...
                  space(AButton.normal(
                      ...
                      height: 30,
                      plain: true,
                      borderColor: Color.fromRGBO(204, 192, 180, 1),
                      onPressed: () {},
                      borderRadius: BorderRadius.circular(44),
                      child: Text(
                        '热',
                ...
                child: Row(
                  children: <Widget>[
                    space(AButton.icon(
                        ...
                        icon: icongouwuche(
                            size: 12, color: Color.fromRGBO(136, 175, 213, 1)),
                        type: 'primary',
                        onPressed: () {})),
                    space(AButton.icon(
                        width: 82,
                    ...
                    space(AButton.icon(
                        ...
                        icon: icongouwuche(
                            size: 12, color: Color.fromRGBO(255, 129, 2, 1)),
                        onPressed: () {})),
                  ],
                ),
              ),
